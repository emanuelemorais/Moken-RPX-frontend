...
const Modal = ({ opened, closeModal }) => {
    ...
    return opened ? (
        <div className="z-100 fixed bg-white flex flex-1 flex-col items-center w-full min-h-screen h-full py-2 px-4">
            <div className="w-full md:w-1/3 flex flex-col justify-center items-center">
                ...
                <div className="w-full flex flex-col items-center">
                    ...
                    <Link
                        href={"/rentals"}
                        className="w-4/5 border-2 border-black rounded-3xl px-4 py-2 flex flex-row justify-between mt-4 items-center shadow-lg transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-105 duration-200"
                        onClick={closeModal}
                    >
                        <div className="flex flex-row items-center" >
                            <p className="font-semibold text-xl ml-2">
